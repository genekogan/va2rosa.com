...
export const cv = [
  ...
  { year: 2026, month: 10, monthLabel: '13–17 October', type: 'film', title: 'Verdelis & Mycos', venue: 'BAIFF, Burano Artificial Intelligence Film Festival. Fondazione Querini Stampalia', city: 'Venice, Italy', now: true, thread: 'little-martians' , href: 'https://www.baiffcinema.eu/' },
  ...
  { year: 2026, month: 8, monthLabel: 'August–October', type: 'exhibition', title: 'Little Martians: Dear Human, My Muse', venue: 'FILE, Electronic Language International Festival, FIESP', city: 'São Paulo, Brazil', now: true, thread: 'little-martians' , href: 'https://file.org.br/' },
  ...
  { year: 2026, month: 9, type: 'talk', title: 'Martians landing at the Embassy', venue: 'The Embassy SF. A talk on Mars College, 11 September 2026', city: 'San Francisco', thread: 'mars-college' , href: 'https://luma.com/p3gsdefb' },
  ...
  { year: 2024, type: 'solo', title: 'Little Martians at Saturn', venue: 'Bombay Beach Biennale, solo exhibition', city: 'Bombay Beach, California', thread: 'little-martians' , href: '/little-martians-saturn', href2: 'https://www.bombaybeachbiennale.org/', href2Label: 'Bombay Beach Biennale' },
  ...
  { year: 2023, type: 'solo', title: 'Little Martians pop-up', venue: 'Re.gen.cy, solo exhibition', city: 'New York', thread: 'little-martians' , href: '/little-martians-popup', href2: 'https://www.instagram.com/re_gen_cy_/', href2Label: 'Re:Gen:Cy' },
  ...
  { year: 2022, month: 7, type: 'exhibition', title: 'Concerto Imersivo, Petrobras Sinfônica', venue: 'Live VR painting with the orchestra, Brazil’s first immersive orchestral concert. Qualistage, 1 July 2022, conducted by Felipe Prazeres', city: 'Rio de Janeiro, Brazil', href: '/petrobras-sinfonica', href2: 'https://petrobrasinfonica.com.br/evento/concerto-imersivo-2/', href2Label: 'Petrobras Sinfônica' },
  { year: 2022, type: 'exhibition', title: 'Simulated Worlds', venue: 'Gray Area Foundation for the Arts', city: 'San Francisco, California', featured: true, thread: 'little-martians', lmSelected: true , href: '/simulated-worlds', href2: 'https://grayarea.org/event/simulated-worlds-participatory-world-building-with-ai/', href2Label: 'Gray Area' },
  { year: 2022, type: 'exhibition', title: 'This Mural is a Time-Traveling Portal', venue: 'Gray Area, with Xenoform Labs as partner', city: 'San Francisco', thread: 'the-silk-roads' , href: 'https://xenoformlabs.com/' },
  ...
  { year: 2016, type: 'exhibition', title: 'As Mulheres nas Ruas', venue: 'Intervention and talk in the Ciclo Feminino em Obras at Midrash Centro Cultural, curated and mediated by Pagu, with Rafa Mon, Criola and Camila Camiz, 28 September', city: 'Leblon, Rio de Janeiro' },
  { year: 2016, type: 'exhibition', title: 'ArtRua', venue: 'Urban art fair, with A7MA Gallery', city: 'Rio de Janeiro, Brazil' },
  { year: 2015, type: 'exhibition', title: 'ArtRua', venue: 'Urban art fair, with Porto Gallery', city: 'Rio de Janeiro, Brazil' },
  ...
  { year: 2011, month: 10, type: 'talk', title: 'Vanguardia Iberoamericana Forum', venue: 'Represented Rede Nami among 100 young leaders from nearly 20 countries, presenting its work against domestic violence. Organised by EVAC, the Government of Paraguay and UNESCO, October 2011', city: 'Asunción, Paraguay' },
  ...
  { year: 2024, type: 'talk', title: 'The Art of World Building: The Little Martians Project', venue: 'Foresight Institute and Protocol Labs, Edge Esmeralda', city: 'Raven Theater, Healdsburg, California', thread: 'little-martians' , href: 'https://www.youtube.com/watch?v=JV10RDZuu14' },
  { year: 2024, type: 'talk', title: 'Artists Exploring Creativity and Language with Generative AI', venue: 'NVIDIA GTC, panellist. Archived on NVIDIA On-Demand', city: '', thread: 'little-martians', lmSelected: true , href: 'https://www.nvidia.com/en-us/on-demand/session/gtc24-s62958/' },
  ...
  { year: 2022, type: 'talk', title: 'Artist talk: the Silk Roads and the Little Martians', venue: 'Xenoform Labs', city: 'San Francisco', thread: 'the-silk-roads' , href: 'https://xenoformlabs.com/' },
  { year: 2022, type: 'teaching', title: 'Simulated Worlds: Participatory World-Building with AI', venue: 'Gray Area, two prompt-writing workshops', city: 'San Francisco', thread: 'little-martians' , href: '/simulated-worlds', href2: 'https://grayarea.org/event/simulated-worlds-participatory-world-building-with-ai/', href2Label: 'Gray Area' },
  ...
  { year: 2017, type: 'talk', title: 'Arte, imagens algorítmicas e diversidade cultural', venue: 'University of Lisbon, Faculty of Architecture, DCG lecture series, 26 October 2017', city: 'Lisbon, Portugal' , href: 'https://www.fa.ulisboa.pt/' },
  { year: 2016, type: 'talk', title: 'Proposições artísticas para a Zona Portuária do Rio de Janeiro', venue: 'University of Lisbon, Faculty of Architecture, DCG lecture series, May 2016', city: 'Lisbon, Portugal', thread: 'visible-memories' , href: 'https://www.fa.ulisboa.pt/' },
  ...
  { year: 2015, type: 'teaching', title: 'Children’s book illustration workshops', venue: 'Editora Viajante do Tempo, 2015 to 2018', city: 'Brazil' , href: 'https://viajantedotempo.com/' },
  { year: 2015, type: 'teaching', title: 'Spray painting workshop', venue: 'SESC Rio', city: 'Rio de Janeiro, Brazil' },
  { year: 2011, type: 'teaching', title: 'Spray painting workshops, Rede Nami', venue: 'Approximately 2011 to 2013', city: 'Rio de Janeiro, Brazil' , href: 'https://redenami.com/' },
  { year: 2011, type: 'teaching', title: 'Drawing classes', venue: 'Centro Cultural Maria Teresa Vieira, three months in 2011', city: '' },
  ...
  { year: 2022, type: 'residency', title: 'Xenoform Labs', venue: 'November', city: 'San Francisco, California', thread: 'the-silk-roads' , href: 'https://xenoformlabs.com/' },
  ...
  { year: 2015, type: 'exhibition', title: 'Pequim +20 em Graffiti', venue: 'UN Women and Rede Nami. The panels became an itinerant exhibition, opening on International Women’s Day at the TV Tower mezzanine, March 2015. Vanessa Rosa’s panel became the image of the III Colloquium on Gender Studies and Feminism at the University of Brasília', city: 'Brasília, Brazil' },
  { year: 2014, type: 'publicart', title: 'Pequim +20 em Graffiti', venue: 'UN Women Brazil, Rede Nami, the Federal District Women’s Secretariat and Instituto Avon. Twelve panels on the themes of the Beijing Platform for Action, painted live on International Women’s Day at Praça do Trabalhador. Vanessa Rosa’s panel was on violence against women', city: 'Ceilândia, Federal District, Brazil' },
  { year: 2012, type: 'publicart', title: 'Coordinator, Arte, Rua & Pluralidade', venue: 'Rede Nami. A 500 m² mural at the Roberto Marinho Foundation headquarters, February 2012: Vanessa Rosa wrote the project, chose the 14 artists and made the layouts', city: 'Rio de Janeiro' , href: 'https://www.frm.org.br/' },
  { year: 2016, type: 'publicart', title: 'Top to Bottom, Arts Org NYC', venue: 'Site-specific public mural project on a three-storey building, with more than 215 artists from New York and abroad', city: 'Long Island City, Queens' },
  { year: 2015, type: 'publicart', title: 'Libre Art Festival', venue: 'Street art festival', city: 'Salvador, Bahia, Brazil' },
  ...
  { year: 2014, type: 'exhibition', title: 'História contada por elas', venue: 'Rede Nami with Espaço Cultural Escola SESC, curated by Panmela Castro. 8 March to 30 April, opening on International Women’s Day', city: 'Jacarepaguá, Rio de Janeiro' },
  { year: 2012, type: 'exhibition', title: 'Ainda É Preciso', venue: '1st International Exhibition of Urban Women Artists, Rede Nami. Espaço Cultural Cedim Heloneida Studart, 24 October to 8 November. Drawing, video, photography, objects and painting by 46 artists from 14 countries', city: 'Rio de Janeiro, Brazil' , href: 'https://redenami.com/' },
  { year: 2011, type: 'publicart', title: 'Quem Ama Abraça, project coordinator', venue: 'Rede Nami campaign against domestic violence, with REDEH and Instituto Magna Mater. Vanessa Rosa coordinated the mural in the arches on Rua Camerino, painted by eight women artists; the painting was filmed for a music video, with Brazilian musicians singing against domestic violence, that was screened across the country. Posters of the mural went up in the Rio subway. November', city: 'Rua Camerino, Rio de Janeiro' },
  { year: 2011, type: 'publicart', title: 'Internami Mural, coordinator', venue: 'Rede Nami. With Angela Rolim, Caca, Luiza Stavale, Om, Prima Donna and Tia Lúcia, for the International Day for the Elimination of Violence against Women: painted 19 November, launched 25 November with Samba de Lei and live painting. Supported by Mama Cash, Suvinil and Instituto Magna Mater', city: 'Pedra do Sal, Rio de Janeiro' , href: 'https://redenami.com/' },
  ...
  // ——— Publishing ———
  { year: 2010, type: 'publication', title: 'Art director, Viajante do Tempo Editora', venue: 'Independent publishing house with more than 120 titles', city: 'Brazil', featured: true , href: 'https://viajantedotempo.com/' },
  ...
  { year: 2014, type: 'publication', title: 'Deu Branco', venue: 'Regina Gonçalves. Illustrated by Vanessa Rosa and Pedro Sarmento. Viajante do Tempo', city: 'Brazil' , href: 'https://viajantedotempo.com/produtos/deu-branco/' },
