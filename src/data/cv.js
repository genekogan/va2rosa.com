...
export const cv = [
  ...
  { year: 2026, type: 'exhibition', title: 'Machine Consciousness Conference (MC0001)', venue: 'Lighthaven. Little Martians Oracle, ceramic installation, gifted to the Center for the Interdisciplinary Study of Machine Consciousness', city: 'Berkeley, California', featured: true, thread: 'little-martians' , href: 'https://machine-consciousness.ai/' },
  ...
  { year: 2025, type: 'exhibition', title: 'Augmented Intelligence', venue: 'Christie’s, Rockefeller Center. The first auction at a major house dedicated to AI art. Little Martians & Abraham exhibited and sold', city: 'New York', featured: true, thread: 'little-martians' , href: 'https://onlineonly.christies.com/s/augmented-intelligence/vanessa-rosa-b-1990-31/250113' },
  { year: 2025, type: 'exhibition', title: 'NeurIPS 2025, Creative AI Track', venue: 'Little Martians: From Desert Clay to Generative Agents, peer-selected paper and work, with Gene Kogan', city: '', featured: true, thread: 'little-martians' , href: 'https://neurips.cc/virtual/2025/events/creative-ai-2025' },
  ...
  { year: 2025, type: 'exhibition', title: 'TokenNation Brasil', venue: 'Fundação Bienal de São Paulo', city: 'São Paulo, Brazil' , href: 'https://bienal.org.br/' },
  ...
  { year: 2023, type: 'exhibition', title: 'Featured Artist, NVIDIA AI Art Gallery', venue: 'One of four featured artists, March 2023 to March 2025', city: '', featured: true, thread: 'little-martians' , href: 'https://www.nvidia.com/en-us/research/ai-art-gallery/artists/vanessa-rosa/' },
  ...
  { year: 2024, type: 'exhibition', title: 'NFT.Brasil', venue: 'Fundação Bienal de São Paulo', city: 'São Paulo, Brazil' , href: 'https://www.nftbrasil.io/' },
  { year: 2024, type: 'exhibition', title: 'Foresight Institute Vision Weekend', venue: 'Bückeburg Castle', city: 'Germany' , href: 'https://foresight.org/' },
  ...
  { year: 2022, type: 'exhibition', title: 'Simulated Worlds', venue: 'Gray Area Foundation for the Arts', city: 'San Francisco, California', featured: true , href: 'https://grayarea.org/event/simulated-worlds-participatory-world-building-with-ai/' },
  ...
  // ——— Films: awards ———
  { year: 2024, type: 'award', title: 'Best Female Director, Super Short Film. Little Martians: Dear Human, My Muse', venue: 'Cannes World Film Festival', city: 'Cannes, France', featured: true, thread: 'little-martians' , href: 'https://www.world-film-festival.com/en/official-results/' },
  { year: 2024, type: 'award', title: 'Global South Special Award', venue: 'Korea International AI Film Festival', city: 'Seoul, South Korea', thread: 'little-martians' , href: 'https://www.gcon.or.kr/eng/aiff.html' },
  ...
  { year: 2024, type: 'talk', title: 'Artists Exploring Creativity and Language with Generative AI', venue: 'NVIDIA GTC, panellist', city: '', href: 'https://www.nvidia.com/en-us/on-demand/session/gtcspring23-s51360/' },
  ...
  { year: 2022, type: 'teaching', title: 'Simulated Worlds: Participatory World-Building with AI', venue: 'Gray Area, workshop', city: 'San Francisco' , href: 'https://grayarea.org/event/simulated-worlds-participatory-world-building-with-ai/' },
  ...
  { year: 2017, type: 'teaching', title: 'Workshops: Laser-Cut Stencils, and From Analog to AI (2022)', venue: 'Pioneer Works', city: 'Brooklyn, New York' , href: 'https://pioneerworks.org/' },
