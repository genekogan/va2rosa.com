...
export const site = {
  ...
  bioShort:
    'Vanessa Rosa (aka va2rosa) is a Brazilian visual artist, art historian by training, based in the United States. Her work merges physical and digital media into a storytelling continuum. Murals become portals to an imaginary world with projection mapping, and ceramics metamorphose into living entities with the aid of AI models.',
  bioLong: [
    'Vanessa Rosa (aka va2rosa) is a Brazilian visual artist, art historian by training, based in the United States. Her work merges physical and digital media into a storytelling continuum. Murals become portals to an imaginary world with projection mapping, and ceramics metamorphose into living entities with the aid of AI models.',
