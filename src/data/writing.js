...
export const groups = [
...

  {
    ...
    items: [
      ...
      { year: 2024, title: 'Artists Exploring Creativity and Language with Generative AI', kind: 'Talk', image: '/images/writing/lm-agentic.webp', imageAlt: 'From the Agentic Storytelling essay.', venue: 'NVIDIA GTC, panellist', detail: '', links: [{ label: 'Watch it on NVIDIA On-Demand', href: 'https://www.nvidia.com/en-us/on-demand/session/gtc24-s62958/' }] },
      { year: 2023, title: 'Custom World Building with AI Avatars: The Little Martians Sci-Fi Project', kind: 'Talk', image: '/images/writing/lm-imaginarium.webp', imageAlt: 'From the Human Imaginarium essay.', venue: 'NVIDIA GTC, featured session', detail: '', links: [{ label: 'Watch it on NVIDIA On-Demand', href: 'https://www.nvidia.com/en-us/on-demand/session/gtcspring23-s51360/' }] },
