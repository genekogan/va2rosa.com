...
export const groups = [
...

  {
    ...
    items: [
      ...
      { year: 2022, title: 'Transforming my watercolours into AI style-transfer animations', kind: 'Essay', detail: 'The NFTs Untitled Frontier minted for “Little Martians and the Human Memorial Monument”: neural style transfer run over my illustrations, rendered as loops. April 2022.', links: [{ label: 'Read it', href: 'https://paragraph.com/@littlemartians/transforming-my-watercolours-into-ai-style-transfer-animations' }] },
      { year: 2022, title: 'Using your own artwork to train an AI', kind: 'Essay', detail: 'Illustrating the Untitled Frontier story with a model trained on my own paintings, rather than on everybody else’s. April 2022.', links: [{ label: 'Read it', href: 'https://paragraph.com/@littlemartians/using-your-own-artwork-to-train-an-ai' }] },
      { year: 2022, title: 'Using DALL·E 2 to illustrate stories', kind: 'Essay', detail: 'The week Gene Kogan got access, we put the short story through it and kept notes. April 2022.', links: [{ label: 'Read it', href: 'https://paragraph.com/@littlemartians/using-dalle-2-to-illustrate-stories' }] },
