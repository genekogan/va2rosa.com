...
export const groups = [
...

  {
    ...
    items: [
      ...
      { year: 2022, title: 'Little Martians: ceramic 3D AI beings', image: '/images/writing/lm-ceramics3d.webp', kind: 'Essay', detail: 'Clay is one of the oldest technologies we have, and a very good heat shield. Could AI breathe life into clay-based humans? August 2022.', links: [{ label: 'Read it', href: 'https://paragraph.com/@littlemartians/little-martians-ceramic-3d-ai-beings' }] },
      { year: 2022, title: 'Phygital murals', image: '/images/mars/mural/m-02.webp', kind: 'Essay', detail: 'Projection mapping over painted walls, finally outdoors: Mars College turned out to be the right place for an idea I had been carrying since the Infinity Game with Wenqi Li in 2017. May 2022.', links: [{ label: 'Read it', href: 'https://paragraph.com/@littlemartians/phygital-murals' }] },
      { year: 2022, title: 'A ceramic temple becomes a 3D scenario', image: '/video/lm-arium-run.webp', kind: 'Essay', detail: 'Gene Kogan wanted a temple for Abraham — a metaverse one. So I made a ceramic sculpture we could 3D scan and build a world around, in real life and in the digital one. May 2022.', links: [{ label: 'Read it', href: 'https://paragraph.com/@littlemartians/a-ceramic-temple-becomes-a-3d-scenario' }] },
      { year: 2022, title: 'Transforming my watercolours into AI style-transfer animations', image: '/images/writing/lm-watercolour.webp', kind: 'Essay', detail: 'The NFTs Untitled Frontier minted for “Little Martians and the Human Memorial Monument”: neural style transfer run over my illustrations, rendered as loops. April 2022.', links: [{ label: 'Read it', href: 'https://paragraph.com/@littlemartians/transforming-my-watercolours-into-ai-style-transfer-animations' }] },
      { year: 2022, title: 'Using your own artwork to train an AI', image: '/images/writing/lm-train.webp', kind: 'Essay', detail: 'Illustrating the Untitled Frontier story with a model trained on my own paintings, rather than on everybody else’s. April 2022.', links: [{ label: 'Read it', href: 'https://paragraph.com/@littlemartians/using-your-own-artwork-to-train-an-ai' }] },
      { year: 2022, title: 'Using DALL·E 2 to illustrate stories', image: '/images/writing/lm-dalle.webp', kind: 'Essay', detail: 'The week Gene Kogan got access, we put the short story through it and kept notes. April 2022.', links: [{ label: 'Read it', href: 'https://paragraph.com/@littlemartians/using-dalle-2-to-illustrate-stories' }] },
      { year: 2022, title: 'Crafting the on-chain SVG Little Martians', image: '/images/lm/onchain/svg-01.webp', kind: 'Essay', detail: 'By Simon de la Rouviere, on building the characters as SVG drawn by code inside the smart contract itself.', links: [{ label: 'Read it', href: 'https://www.untitledfrontier.studio/blog/crafting-the-on-chain-svg-little-martians' }] },
      { year: 2021, title: 'Little Martians: from ceramics to 3D animations', image: '/images/lm/ceramics/c-02.webp', kind: 'Essay', detail: 'What happens when you fire untested local clay too hot (the sculptures melt, beautifully), and what silicone moulds make possible: enough small sculptures to experiment with every glaze.', links: [{ label: 'Read it', href: 'https://marscollege.substack.com/p/little-martians-from-ceramics-to' }] },
      { year: 2021, title: 'Ceramics with local clay', image: '/images/writing/lm-localclay.webp', kind: 'Essay', detail: 'Digging and processing clay from the ground at Bombay Beach.', links: [{ label: 'Read it', href: 'https://marscollege.substack.com/p/ceramics-with-local-clay' }] },
    ],
  },
...

  {
    ...
    items: [
      ...
      { year: 2024, title: 'Artists Exploring Creativity and Language with Generative AI', kind: 'Talk', image: '/images/writing/lm-agentic.webp', imageAlt: 'From the Agentic Storytelling essay.', venue: 'NVIDIA GTC 2024, San Jose · panel', detail: 'A panel on the tools generative AI gives artists for language and storytelling, chaired by Wallis Mills of NVIDIA, with Andrea Gagliano (Getty Images), Pinar Seyhan Demirdag (Seyhan Lee and Cuebric), Amelia Winger-Bearskin (Studio Amelia) and Youmna Chamcham (Mini Studio AI).', links: [{ label: 'Watch it on NVIDIA On-Demand', href: 'https://www.nvidia.com/en-us/on-demand/session/gtc24-s62958/' }] },
      { year: 2023, title: 'Custom World Building with AI Avatars: The Little Martians Sci-Fi Project', kind: 'Talk', image: '/images/writing/lm-imaginarium.webp', imageAlt: 'From the Human Imaginarium essay.', venue: 'NVIDIA GTC Digital Spring 2023 · featured session', detail: 'How the Little Martians are made, and what physical things are for in a world built with AI: each character begins as a sculpture in ceramic, 3D print or resin, is scanned, and becomes an avatar inside the simulation.', links: [{ label: 'Watch it on NVIDIA On-Demand', href: 'https://www.nvidia.com/en-us/on-demand/session/gtcspring23-s51360/' }] },
      ...
      { year: 2017, title: 'Arte, imagens algorítmicas e diversidade cultural', kind: 'Lecture',
        image: '/images/work/dissertation-cover.webp',
        imageAlt: 'The dissertation cover: stencilled patterns with a black Adinkra symbol at the centre.',
        venue: 'DCG lecture series, Faculty of Architecture, University of Lisbon · 26 October 2017',
        detail: 'Art, algorithmic images and cultural diversity: the master’s research, given as a lecture in Lisbon.',
        links: [{ label: 'The faculty', href: 'https://www.fa.ulisboa.pt/' }] },
      ...
      { year: 2016, title: 'Proposições artísticas para a Zona Portuária do Rio de Janeiro', kind: 'Lecture',
        image: '/images/vm/p2010-figures.webp',
        imageAlt: 'Life-size painted figures on a wall in Rio’s port zone.',
        venue: 'DCG lecture series, Faculty of Architecture, University of Lisbon · May 2016',
        detail: 'Artistic propositions for Rio’s port zone: the work in Morro da Conceição and Pedra do Sal.',
        links: [{ label: 'The faculty', href: 'https://www.fa.ulisboa.pt/' }] },
    ],
  },
];
