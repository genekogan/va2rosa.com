...
export const veracidade = {
  ...
  title: 'Ver(a)cidade',
  hero: '/images/vc/vc-pai-1.webp',
  heroAlt: 'The hall at Caixa Cultural seen from the upper floor: drawn figures on the columns, the spiral stair below.',
  ...
  intro: [
    'A collective exhibition that brought thirteen artists to the Caixa Cultural Center in Rio de Janeiro, each one with their own interpretation of the urban scene. I chose to occupy the space in a way that bound the show’s two floors together, interacting with the most impactful architectonic elements in Caixa Cultural: the hall’s columns and the central stairway.',
    'My participation can be seen as three different works, or as one with changes of medium and strategy: a drawn curtain behind the stairs, passers-by painted along the stairway itself, and an anamorphic landscape on the columns that only resolves from certain points of the upper floor.',
  ...
  sections: [
    {
      title: 'Moucharabieh',
      body: [
        'Behind the stairs one would find what seemed to be black curtains with transparent areas, creating an oneiric drawing of Rio’s downtown architecture. The drawing builds a landscape where only the windows appear, as if it were a dark night and all the lights were on. Through the transparent areas one sees a second drawing behind the curtains: a stairway that leads to an old building with many other stairs and little secrets, inspired by Rio’s old architecture, Arabic moucharabiehs and Piranesi’s etchings.',
      ],
      note: 'Painted plastic, steel cable and tracing paper. 4.2 × 6.6 × 1.3 m, 2012.',
      gallery: 'slides',
      images: [
        { src: '/images/vc/vc-mou-1.webp', caption: 'The drawn skyline, where only the lit windows appear' },
        { src: '/images/vc/vc-mou-2.webp', caption: 'Detail' },
        { src: '/images/vc/vc-mou-3.webp', caption: 'Detail' },
        { src: '/images/vc/vc-mou-4.webp', caption: 'The curtain under the hall lights' },
        { src: '/images/vc/vc-mou-5.webp', caption: 'The curtains hung behind the central stairway' },
        { src: '/images/vc/vc-mou-6.webp', caption: 'The far side, seen along the corridor' },
        { src: '/images/vc/vc-mou-7.webp', caption: 'The drawing behind the curtain, seen through the transparent areas' },
        { src: '/images/vc/vc-mou-8.webp', caption: 'The stairway that leads to an old building, drawn on tracing paper' },
      ],
    },
    {
      title: 'Paisagem',
      body: [
        'On the second floor, an image made of drawings glued over the central columns. The drawings are anamorphic: from some points of view they gather into one landscape floating over the main hall, and from every other point they come apart again.',
      ],
      note: 'Photographic enlargements plotted on vinyl, over the columns. 42.6 m², 2012.',
      gallery: 'slides',
      images: [
        { src: '/images/vc/vc-pai-1.webp', caption: 'From the upper floor, where the drawings gather into one landscape' },
        { src: '/images/vc/vc-pai-2.webp', caption: 'The hall from the ground floor' },
        { src: '/images/vc/vc-pai-3.webp', caption: 'The columns and the stairway together' },
      ],
    },
    {
      title: 'Rabiscos',
      body: [
        'Along the central stairway I drew passers-by, taken from watching the day to day of downtown Rio. They were painted in gouache, so the images stayed vulnerable to the visitors who brushed past them.',
      ],
      note: 'Gouache on the stairway wall and handrail. Dimensions variable, 2012.',
      gallery: 'slides',
      images: [
        { src: '/images/vc/vc-rab-1.webp', caption: 'The painted figures below, the drawn city above' },
        { src: '/images/vc/vc-rab-2.webp', caption: 'Passers-by, gouache on the wall' },
        { src: '/images/vc/vc-rab-3.webp', caption: 'A group of walkers along the stairway' },
      ],
    },
  ],
};
